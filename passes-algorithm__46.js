...
function scoreAttraction(attraction, userPreferences) {
  ...
  if (bestFor.includes(userPreferences.travelGroup) || bestFor.includes('all')) {
    ...
    score += 10;
    scoreEl += `<div><b><i>Best for:</i></b> ${userPreferences.travelGroup} +${score} points</div>`;
  }
  ...
  scoreEl += `<div><b><i>Season (${userPreferences.startDate}):</i></b> ${season} +${score}  points</div>`;
  ...
  console.log('userPreferences.pace::', userPreferences.pace)
